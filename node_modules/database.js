...
module.exports.createCitation = function(loginId, sourceURL, sourceAuthor, sourceTitle, containerTitle, publisherTitle, sourcePublicationDate, callback) {
    query("INSERT INTO Citation (Login_id, sourceURL, sourceAuthor, sourceTitle, containerTitle, publisherTitle, sourcePublicationDate) VALUES (?, ?, NULLIF(?, ''), NULLIF(?, ''), NULLIF(?, ''), NULLIF(?, ''), NULLIF(?, ''));", [loginId, sourceURL, sourceAuthor, sourceTitle, containerTitle, publisherTitle, sourcePublicationDate], function(rows) {
        if (rows == null) {
...
var formatCitation = function(citation) {
    ...
    if (citation.sourceAuthor) {
        if (citation.sourceAuthor.indexOf('.') == -1 && citation.sourceAuthor.indexOf(',') == -1 && citation.sourceAuthor.split(' ').length == 2) {
